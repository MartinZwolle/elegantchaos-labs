...
image: /images/posts/idee-naar-site.png
---
...
Tot voor kort was een een trouwe Wordpress gebruiker. Dat is zware overkill voor iemand die alleen af en toe een tekstje wil schrijven. En je hebt bijna een dagtaak aan updates en lekken en leuke plugins die zomaar niet meer doorontwikkeld worden.
...
## Obsidian
In Obsidian maak ik een markdown berichtje. Waarin alle informatie netjes meekomt zoals, tags, excerpt, datum en welke njk template gebruikt moet worden. Met de Community plugin **Blog Bridge**, kan ik deze naar GitHub committen.

## Github 
In Github wordt dit markdown bericht klaargezet in de juiste map.
...
- En natuurlijk qua content nog wat zaken. Een RSS-feed bijvoorbeeld
